...
export function getUserInfo(data) {
	return request.get('customer/getCustomerInfo',data,{
		noAuth: true
	});
}
...
export function logout(data) {
	return request.post('passport/logout',data,{
		noAuth: true
	});
}
...
export function orderNum(data) {
	return request.get('quoted/static',data,{
		noAuth: true
	});
}
...
export function articleInfo(data) {
	return request.get('article/getArticleInfo',data,{
		noAuth: true
	});
}
