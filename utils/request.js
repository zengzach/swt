...
// 生产环境
// var secret = '60484c510fc7fccdbd173ad8fd837532'
...
function baseRequest(url, method, data, {
	...
	return new Promise((reslove, reject) => {
		...
		header['username'] = Encrypt(userName)
		header['timestamp'] = Encrypt(time)
		header['sign'] = Encrypt(sign)
		header['token'] = Encrypt(token)
		header['orgNum'] = Encrypt(orgNum)
