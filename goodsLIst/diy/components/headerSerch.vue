<template>
	...
	<view class="header"
		...
		<view class="serch-wrapper acea-row row-middle" :style="'padding-left:'+ prConfig*2 +'rpx;'">
			<view class="logo skeleton-rect" v-if="logoConfig" @click="backBtn">
				<image :src="logoConfig" mode="heightFix"></image>
			</view>
			<view class="logo skeleton-rect" v-else style="height: 40rpx;margin-top: 20rpx;"  @click="backBtn">
				<image src="https://oss-sp-data.oss-cn-hangzhou.aliyuncs.com/img/wx/red/integral/back_black.png"
					mode="heightFix"></image>
			</view>
			<navigator url="/goodsLIst/search" class="input acea-row row-middle skeleton-rect"
...
<script>
	...
	export default {
		...
		methods: {
			backBtn() {
				uni.switchTab({
					url:"/pages/index/index?dpzxFlag=false"
				})
			},
...
<style scoped>
	.mp-header .serch-wrapper {
		display: flex;
	}

	.mp-header .serch-wrapper .input.fillet {
		margin-top: 16rpx;
	}
</style>
